<nav class="mobile-top-bar bg-primary">
    <div class="flex items-center justify-between h-full px-4 py-3">
        <!-- Logo di kiri -->
        <h1 class="text-xl font-bold text-white flex-shrink-0 mr-4"><span class="text-secondary">Ayo</span>buatbaik</h1>
