...
@section('content')
<div class="p-6">
    <h1 class="text-xl font-bold mb-6">Edit Kategori Donasi</h1>
    ...
    <form action="{{ route('admin.kategori_donasi.update', $kategori->id) }}" method="POST" class="space-y-5 bg-white p-6 shadow rounded">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <textarea name="deskripsi" rows="4"
                      class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-500">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
        </div>
