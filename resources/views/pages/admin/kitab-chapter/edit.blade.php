    ...
    <div class="max-w-4xl mx-auto mt-8">
        <div class="bg-white shadow-sm rounded-xl p-6 border border-gray-100">
            ...
            <form action="{{ route('admin.kitab_chapter.update', $kitabChapter->id) }}" method="POST" class="space-y-6">
                ...
                <!-- Deskripsi -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi <span class="text-xs text-gray-400 font-normal">(Maksimal ~4 baris / 400 karakter)</span></label>
