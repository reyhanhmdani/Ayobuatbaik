...
@section('content')
    <div class="max-w-4xl mx-auto mt-8">
        <div class="bg-white shadow-sm rounded-xl p-6 border border-gray-100">
            <h2 class="text-lg font-semibold text-gray-800 mb-6">Tambah Berita</h2>
            ...
            <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}"
                        class="w-full border-0 border-b border-gray-300 focus:border-primary focus:ring-0"
                        placeholder="Slug otomatis atau manual">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="deskripsi_singkat" value="{{ old('deskripsi_singkat') }}"
                        class="w-full border rounded px-3 py-2" placeholder="Tuliskan ringkasan berita">
                </div>
