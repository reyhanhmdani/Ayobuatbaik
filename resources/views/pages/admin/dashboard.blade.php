            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    <div class="w-12 h-12 bg-cover bg-center rounded-lg"
                        style="background-image: url('{{ asset('assets/img/beasiswaashabi.jpeg') }}')"></div>
                    <div class="flex-1">
                        ...
                        <div class="flex items-center space-x-2 mt-1">
                            <div class="flex-1 bg-gray-200 rounded-full h-2">
                                <div class="bg-secondary h-2 rounded-full"
                                    style="width: {{ $program['progress_percentage'] ?? 0 }}%"></div>
                            </div>
                            <span class="text-xs text-gray-500">{{ $program['progress_percentage'] ?? 0 }}%</span>
                        </div>
                    </div>
                </div>
                @empty
